...
#define MAVLINK_MSG_ID_PARAM_EXT_VALUE_CRC 68
#define MAVLINK_MSG_ID_322_CRC 68
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE { \
    ...
    {  { "param_count", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_param_ext_value_t, param_count) }, \
         ...
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_param_ext_value_t, param_type) }, \
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 5, offsetof(mavlink_param_ext_value_t, param_id) }, \
         { "param_value", NULL, MAVLINK_TYPE_CHAR, 128, 21, offsetof(mavlink_param_ext_value_t, param_value) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_VALUE { \
...
{
    return mavlink_msg_param_ext_value_pack(system_id, component_id, msg, param_ext_value->param_count, param_ext_value->param_index, param_ext_value->param_type, param_ext_value->param_id, param_ext_value->param_value);
}
...
{
    return mavlink_msg_param_ext_value_pack_chan(system_id, component_id, chan, msg, param_ext_value->param_count, param_ext_value->param_index, param_ext_value->param_type, param_ext_value->param_id, param_ext_value->param_value);
}
...
{
    return mavlink_msg_param_ext_value_pack_status(system_id, component_id, _status, msg,  param_ext_value->param_count, param_ext_value->param_index, param_ext_value->param_type, param_ext_value->param_id, param_ext_value->param_value);
}
...
static inline void mavlink_msg_param_ext_value_send(mavlink_channel_t chan, uint16_t param_count, uint16_t param_index, uint8_t param_type, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_VALUE_LEN];
    _mav_put_uint16_t(buf, 0, param_count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_value_send(chan, param_ext_value->param_count, param_ext_value->param_index, param_ext_value->param_type, param_ext_value->param_id, param_ext_value->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_ext_value_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t param_count, uint16_t param_index, uint8_t param_type, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
