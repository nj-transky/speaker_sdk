...
#define MAVLINK_MSG_ID_PARAM_EXT_ACK_CRC 0
#define MAVLINK_MSG_ID_324_CRC 0
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_ACK { \
    ...
    "PARAM_EXT_ACK", \
    4, \
    {  { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_param_ext_ack_t, param_type) }, \
         { "param_result", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_param_ext_ack_t, param_result) }, \
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 2, offsetof(mavlink_param_ext_ack_t, param_id) }, \
         { "param_value", NULL, MAVLINK_TYPE_CHAR, 128, 18, offsetof(mavlink_param_ext_ack_t, param_value) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_ACK { \
...
static inline uint16_t mavlink_msg_param_ext_ack_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t param_type, uint8_t param_result, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN];
    _mav_put_uint8_t(buf, 0, param_type);
    _mav_put_uint8_t(buf, 1, param_result);
...
{
    return mavlink_msg_param_ext_ack_pack(system_id, component_id, msg, param_ext_ack->param_type, param_ext_ack->param_result, param_ext_ack->param_id, param_ext_ack->param_value);
}
...
{
    return mavlink_msg_param_ext_ack_pack_chan(system_id, component_id, chan, msg, param_ext_ack->param_type, param_ext_ack->param_result, param_ext_ack->param_id, param_ext_ack->param_value);
}
...
{
    return mavlink_msg_param_ext_ack_pack_status(system_id, component_id, _status, msg,  param_ext_ack->param_type, param_ext_ack->param_result, param_ext_ack->param_id, param_ext_ack->param_value);
}
...
static inline void mavlink_msg_param_ext_ack_send(mavlink_channel_t chan, uint8_t param_type, uint8_t param_result, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_ACK_LEN];
    _mav_put_uint8_t(buf, 0, param_type);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_ack_send(chan, param_ext_ack->param_type, param_ext_ack->param_result, param_ext_ack->param_id, param_ext_ack->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_ext_ack_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t param_type, uint8_t param_result, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
