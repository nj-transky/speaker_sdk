...
#define MAVLINK_MSG_ID_TqFcIdOutput_LEN 9
#define MAVLINK_MSG_ID_TqFcIdOutput_MIN_LEN 9
#define MAVLINK_MSG_ID_30048_LEN 9
#define MAVLINK_MSG_ID_30048_MIN_LEN 9

#define MAVLINK_MSG_ID_TqFcIdOutput_CRC 127
#define MAVLINK_MSG_ID_30048_CRC 127
...
#define MAVLINK_MESSAGE_INFO_TqFcIdOutput { \
    ...
    {  { "pos_cmd_p", NULL, MAVLINK_TYPE_INT64_T, 0, 0, offsetof(mavlink_tqfcidoutput_t, pos_cmd_p) }, \
         { "state_now", NULL, MAVLINK_TYPE_INT8_T, 0, 8, offsetof(mavlink_tqfcidoutput_t, state_now) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_TqFcIdOutput { \
...
{
    return mavlink_msg_tqfcidoutput_pack(system_id, component_id, msg, tqfcidoutput->pos_cmd_p, tqfcidoutput->state_now);
}
...
{
    return mavlink_msg_tqfcidoutput_pack_chan(system_id, component_id, chan, msg, tqfcidoutput->pos_cmd_p, tqfcidoutput->state_now);
}
...
{
    return mavlink_msg_tqfcidoutput_pack_status(system_id, component_id, _status, msg,  tqfcidoutput->pos_cmd_p, tqfcidoutput->state_now);
}
...
static inline void mavlink_msg_tqfcidoutput_send(mavlink_channel_t chan, int64_t pos_cmd_p, int8_t state_now)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TqFcIdOutput_LEN];
    _mav_put_int64_t(buf, 0, pos_cmd_p);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_tqfcidoutput_send(chan, tqfcidoutput->pos_cmd_p, tqfcidoutput->state_now);
#else
 ...
 */
static inline void mavlink_msg_tqfcidoutput_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int64_t pos_cmd_p, int8_t state_now)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
