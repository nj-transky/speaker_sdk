...
#define MAVLINK_MSG_ID_PARAM_EXT_SET_CRC 249
#define MAVLINK_MSG_ID_323_CRC 249
...
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_SET { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_param_ext_set_t, target_system) }, \
         ...
         { "param_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_param_ext_set_t, param_type) }, \
         { "param_id", NULL, MAVLINK_TYPE_CHAR, 16, 3, offsetof(mavlink_param_ext_set_t, param_id) }, \
         { "param_value", NULL, MAVLINK_TYPE_CHAR, 128, 19, offsetof(mavlink_param_ext_set_t, param_value) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_SET { \
...
{
    return mavlink_msg_param_ext_set_pack(system_id, component_id, msg, param_ext_set->target_system, param_ext_set->target_component, param_ext_set->param_type, param_ext_set->param_id, param_ext_set->param_value);
}
...
{
    return mavlink_msg_param_ext_set_pack_chan(system_id, component_id, chan, msg, param_ext_set->target_system, param_ext_set->target_component, param_ext_set->param_type, param_ext_set->param_id, param_ext_set->param_value);
}
...
{
    return mavlink_msg_param_ext_set_pack_status(system_id, component_id, _status, msg,  param_ext_set->target_system, param_ext_set->target_component, param_ext_set->param_type, param_ext_set->param_id, param_ext_set->param_value);
}
...
static inline void mavlink_msg_param_ext_set_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t param_type, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PARAM_EXT_SET_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_set_send(chan, param_ext_set->target_system, param_ext_set->target_component, param_ext_set->param_type, param_ext_set->param_id, param_ext_set->param_value);
#else
 ...
 */
static inline void mavlink_msg_param_ext_set_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t param_type, const char *param_id, const char *param_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
