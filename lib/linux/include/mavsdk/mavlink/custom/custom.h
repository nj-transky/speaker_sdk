...
#define MAVLINK_CUSTOM_XML_HASH 8096099827653220386
...
typedef enum MAV_USER_COMPONENT
{
   ...
   MAV_USER_COMPONENT_ENUM_END=51, /*  | */
} MAV_USER_COMPONENT;
#endif
