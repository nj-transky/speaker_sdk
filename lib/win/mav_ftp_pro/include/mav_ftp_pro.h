...
// #ifdef WINDOWS
//     #define MAVFTP_PRO_API __declspec(dllexport) 
// #else
//     #define MAVFTP_PRO_API __attribute__((visibility("default")))   
// #endif

#ifdef _WIN32
    #ifdef MAVFTP_PRO_EXPORTS
        #define MAVFTP_PRO_API __declspec(dllexport)
    #else
        #define MAVFTP_PRO_API __declspec(dllimport)
    #endif
#else
    #define MAVFTP_PRO_API
#endif
...
public:
     ...
     */
    explicit Ftp(std::string url); // deprecated
