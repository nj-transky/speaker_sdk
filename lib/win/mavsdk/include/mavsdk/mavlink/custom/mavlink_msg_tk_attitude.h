...
typedef struct __mavlink_tk_attitude_t {
 float pitchAngle; /*< [бу] Pitch, unit degree.*/
 float rollAngle; /*< [бу] Roll, unit degree.*/
 float yawAngle; /*< [бу] Yaw, unit degree.*/
 float angular_velocity_x; /*< [бу/s] Angular velocity X-axis, unit degree per second.*/
 float angular_velocity_y; /*< [бу/s] Angular velocity Y-axis, unit degree per second.*/
 float angular_velocity_z; /*< [бу/s] Angular velocity Z-axis, unit degree per second.*/
 ...
 * @param pitchAngle [бу] Pitch, unit degree.
 * @param rollAngle [бу] Roll, unit degree.
 * @param yawAngle [бу] Yaw, unit degree.
 * @param angular_velocity_x [бу/s] Angular velocity X-axis, unit degree per second.
 * @param angular_velocity_y [бу/s] Angular velocity Y-axis, unit degree per second.
 * @param angular_velocity_z [бу/s] Angular velocity Z-axis, unit degree per second.
 ...
 *
 * @return [бу/s] Angular velocity X-axis, unit degree per second.
 */
 ...
 *
 * @return [бу/s] Angular velocity Y-axis, unit degree per second.
 */
 ...
 *
 * @return [бу/s] Angular velocity Z-axis, unit degree per second.
 */
