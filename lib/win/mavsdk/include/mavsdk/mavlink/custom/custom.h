...
#define MAVLINK_CUSTOM_XML_HASH 3800105130244051066
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_MOTOR_SET_CUR_POSITION_TO_ANY_ANGLE=51621, /*  Host sends this command to set the motor's current position as any angle (multi-turn). The multi-turn angle value motorAngle is int32_t type data, with unit 0.01бу/LSB. |Multi-turn angle value. |The multi-turn angle value motorAngle is float type data, with unit 0.01бу/LSB.| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  */
